...
public class LipishaClient {
     ...
     * @return
     */
    public TransactionsResponse reverseTransaction(String transactionId) {
     ...
     * @return
     */
    public TransactionsResponse reverseTransaction(String[] transactionIds) {
        StringBuilder listBuilder = new StringBuilder();
        String delim = "";
        for (String i : transactionIds) {
            listBuilder.append(delim).append(i);
     ...
     * @return
     */
    public TransactionsResponse getTransactions(@Nullable String transactionIds,
     ...
     * @param transactionMethods
     * @param transactionDateStart
     * @param transactionDateEnd
     * @param transactionAccountNames
     * @param transactionAccountNumbers
     * @param transactionReferences
     * @param transactionAmountMinimum
     * @param transactionAmountMaximum
     * @param transactionStatuses
     * @param transactionName
     * @param transactionMobileNumber
